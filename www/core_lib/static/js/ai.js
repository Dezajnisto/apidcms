...
var AIAssistant = {
    ...
    injectStyles: function() {
        ...
        style.textContent = [
            ...
            '.ai-msg-bubble table { width: 100%; border-collapse: collapse; margin: 8px 0; font-size: 13px; }',
            '.ai-msg-bubble th { background: #f3f4f6; padding: 8px 12px; text-align: left; font-weight: 600; border: 1px solid #d1d5db; }',
            '.ai-msg-bubble td { padding: 6px 12px; border: 1px solid #e5e7eb; }',
            '.ai-msg-bubble tr:nth-child(even) td { background: #f9fafb; }',
